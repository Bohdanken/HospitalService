...
// @Test
// @Order(3)
// @DisplayName("It should generate a JWT token and return a valid token
// response")
...
// @Test
// @Order(5)
// @DisplayName("It should return null and not throw an error if a token is
// invalid")
// public void getNullIfTokenIsInvalid() {
// String email = assertDoesNotThrow(() ->
// jwtService.getUserEmailFromToken(""));
